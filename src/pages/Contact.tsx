  ...
  return (
    <div className="contact">
      ...
      <div className="contact__container">
        ...
        <TextField id="standard-basic" label="Nom" variant="standard" sx={{m:1, width:"40ch"}}/>
        <TextField id="standard-basic" label="Prénom" variant="standard" sx={{m:1, width:"40ch"}} />
        </div>
        <div className="contact__container__form__mail">
        <TextField id="standard-basic" label="Email" variant="standard" sx={{m:1, width:"40ch"}} />
        </div>
        ...
        <FormControlLabel control={<Checkbox  />} label="Je ne suis pas un robot"
